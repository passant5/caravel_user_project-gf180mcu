...
# Timing Constraints
###############################################################################
create_clock -name clk -period 30 [get_ports {wb_clk_i}] 
create_clock -name user_clock2 -period 10.0000 [get_ports {user_clock2}]
set_clock_uncertainty 0.1000 [get_clocks {clk user_clock2}]
set_propagated_clock [get_clocks {clk user_clock2}]
